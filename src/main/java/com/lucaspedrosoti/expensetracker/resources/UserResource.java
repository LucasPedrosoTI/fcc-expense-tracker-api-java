...
import com.lucaspedrosoti.expensetracker.Constants;
import com.lucaspedrosoti.expensetracker.domain.User;
import com.lucaspedrosoti.expensetracker.services.UserService;
...
public class UserResource {
  ...
  private Map<String, String> generateJWT(User user) {
    ...
    String token = Jwts.builder().signWith(SignatureAlgorithm.HS256, Constants.API_SECRET_KEY)
        ...
        .claim("userId", user.getUserId()).claim("email", user.getEmail()).claim("firstName", user.getFirstName())
